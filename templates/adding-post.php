                                    ...
                                    <?php foreach ($forms[$current_tab]['inputs'] as $input): ?>
                                        <div class="adding-post__input-wrapper form__input-wrapper">
                                            ...
                                            <div class="form__input-section <?php if (isset($errors[$type['class_name'] . '-heading'])): ?>form__input-section--error<?php endif; ?>">
                                                <input class="adding-post__input form__input" id="<?= $current_tab; ?>-<?= $input['name']; ?>" type="<?= $input['type']; ?>" name="<?= $current_tab; ?>-<?= $input['name']; ?>" value="<?= $_POST[$current_tab . '-' . $input['name']] ?? ''; ?>" placeholder=<?= $input['placeholder'] ?? ''; ?>>

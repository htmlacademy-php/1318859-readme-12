                    ...
                    <ul class="adding-post__tabs-list filters__list tabs__list">
                        <?php foreach ($tabs as $post_type => $tab_name) : ?>
                            <li class="adding-post__tabs-item filters__item">
                                <a class="adding-post__tabs-link filters__button filters__button--<?= $post_type ??
                                '' ?>
                                <?php if ($current_tab === $post_type) : ?>
                                filters__button--active tabs__item--active
                                <?php endif; ?> tabs__item button" href="add.php?type=<?= $post_type ?? '' ?>">
                ...
                <div class="adding-post__tab-content">
                    <section class="adding-post__<?= $current_tab ?? '' ?> tabs__content tabs__content--active">
                        ...
                        <form class="adding-post__form form"
                              action="add.php?type=<?= $current_tab ?? '' ?>"
                              method="post"
                            <?php if ($current_tab === 'photo') : ?>
                            ...
                            <div class="form__text-inputs-wrapper">
                                <div class="form__text-inputs">
                                    ...
                                    <?php foreach ($form['inputs'] as $input) : ?>
                                        <?php if (isset($input['field_type'])
                                            && $input['field_type'] === 'input-file'
                                        ) : ?>
                                            <div class="adding-post__<?= $input['field_type'] ??
                                            '' ?>-container form__input-container form__input-container--file">
                                                <div class="adding-post__<?= $input['field_type'] ??
                                                '' ?>-wrapper form__<?= $input['field_type'] ?? '' ?>-wrapper">
                                                    <div class="adding-post__file-zone
                                                    adding-post__file-zone--photo form__file-zone dropzone">
                                                    ...
                                                    form__input-file-button form__input-file-button--photo button"
                                                            type="button">
                                                ...
                                                <div class="adding-post__file
                                                adding-post__file--photo form__file dropzone-previews"></div>
                                            </div>
                                        <?php else : ?>
                                            <div class="adding-post__<?= $input['field_type'] ??
                                            '' ?>-wrapper form__<?= $input['field_type'] ?? '' ?>-wrapper">
                                                <label class="adding-post__label form__label"
                                                       for="<?= $current_tab ?? '' ?>-<?= $input['name']
                                                        ?? '' ?>"><?= $input['title']
                                                ...
                                                <?php endif; ?>">
                                                    ...
                                                    <?php if (isset($input['field_type']) && isset($input['name'])) : ?>
                                                    ...
                                                    <?php if (!empty($errors[$form['name']])
                                                        ...
                                                        <div class="form__error-text">
                                                            <h3 class="form__error-title"><?= $input['title'] ??
                                                                '' ?></h3>

        ...
        <div class="adding-post container">
            <div class="adding-post__tabs-wrapper tabs">
                    ...
                    <ul class="adding-post__tabs-list filters__list tabs__list">
                        <?php foreach ($types as $type): ?>
                            <li class="adding-post__tabs-item filters__item">
                                ...
                                <a class="adding-post__tabs-link filters__button filters__button--<?= $type['class_name']; ?> <?php if ($id === strval($type['id'])): ?>filters__button--active tabs__item--active<?php endif; ?> tabs__item button">
                ...
                <div class="adding-post__tab-content">
                    ...
                    <?php foreach ($types as $type): ?>
                        <section class="adding-post__<?= $type['class_name']; ?> tabs__content <?php if ($id === strval($type['id'])): ?>tabs__content--active<?php endif; ?>">
                                ...
                                <div class="form__text-inputs-wrapper">
                                    <div class="form__text-inputs">
                                        <div class="adding-post__input-wrapper form__input-wrapper">
                                            ...
                                            <div class="form__input-section">
                                                <input class="adding-post__input form__input" id="<?= $type['class_name']; ?>-heading" type="text" name="<?= $type['class_name']; ?>-heading" value="<?= $_POST[$type['class_name'] . "-heading"]; ?>" placeholder="Введите заголовок">
                                        ...
                                        <div class="adding-post__input-wrapper form__input-wrapper">
                                            ...
                                            <div class="form__input-section">
                                                <input class="adding-post__input form__input" id="<?= $type['class_name']; ?>-tags" type="text" name="<?= $type['class_name']; ?>-tags" placeholder="Введите теги">
                                                <button class="form__error-button button" type="button">
                                                    !<span class="visually-hidden">Информация об ошибке</span></button>
                                                <div class="form__error-text">
                                                    <h3 class="form__error-title">Заголовок сообщения</h3>
                                    ...
                                    <div class="form__invalid-block">
                                        ...
                                        <ul class="form__invalid-list">
                                            ...
                                            <?php if ($type['class_name'] === 'photo'): ?>
                                                <li class="form__invalid-item">Укажите ссылку на картинку или загрузите
                                                    файл с компьютера.
                                                </li>
                                                <li class="form__invalid-item">Некорректный URL-адрес.</li>
                                                <li class="form__invalid-item">Не удалось загрузить файл по ссылке.</li>
                                            ...
                                            <?php elseif ($type['class_name'] === 'quote'): ?>
                                                ...
                                                <li class="form__invalid-item">Автор. Это поле должно быть заполнено.
                                                </li>
                                            <?php elseif ($type['class_name'] === 'link'): ?>
                                                <li class="form__invalid-item">Ссылка. Это поле должно быть заполнено.
                                                </li>
                                            <?php endif; ?>
                                            <li class="form__invalid-item">Теги. Нужно указать минимум один тег.</li>
                                        </ul>
                                    </div>
                                </div>

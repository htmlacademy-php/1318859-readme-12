        ...
        <section class="feed">
                                    ...
                                    <a class="post__author-link"
                                       ...
                                       title="Автор">
                                        ...
                                        <div class="post__info">
                                            <b class="post__author-name"><?= htmlspecialchars($post['login'] ??
                                                    '') ?></b>
                                    ...
                                    <div class="post__buttons">
                                        ...
                                        <?= (isset($reposted_post_ids_by_session_user)
                                           ...
                                           href="feed.php?reposted_post_id=<?= $post['id'] ?? '' ?>" title="Репост">
                                            ...
                                            <span><?= (isset($post['id']))
                                                    ? count_reposts_of_post($con, $post['id']) : '' ?></span>
            ...
            <ul class="feed__filters filters">
                ...
                <?php foreach ($tabs as $type => $tab_name) : ?>
                    <li class="feed__filters-item filters__item">
                        <a class="filters__button <?= $type ? "filters__button--" . $type : '' ?> <?= ($current_tab
                            === $type) ? 'filters__button--active' : '' ?> button" href="feed.php?type=<?= $type ??
                        '' ?>">

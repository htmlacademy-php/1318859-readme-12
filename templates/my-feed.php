        ...
        <section class="feed">
            ...
            <div class="feed__main-wrapper">
                <div class="feed__wrapper">
                    <?php if (!empty($current_tab_posts)): ?>
                                ...
                                <footer class="post__footer post__indicators">
                                    <div class="post__buttons">
                                        <a class="post__indicator post__indicator--likes button <?= (isset($liked_post_ids_by_session_user) && in_array($post['id'], $liked_post_ids_by_session_user)) ? 'post__indicator--likes-active' : '' ?>"
                                           href="feed.php?liked_post_id=<?= $post['id'] ?? '' ?>" title="Лайк">
                                        ...
                                        <a class="post__indicator post__indicator--repost button <?= (isset($reposted_post_ids_by_session_user) && in_array($post['id'], $reposted_post_ids_by_session_user)) ? 'post__indicator--repost-active' : '' ?>"
                                           href="feed.php?reposted_post_id=<?= $post['id'] ?? '' ?>" title="Репост">
            ...
            <ul class="feed__filters filters">
                ...
                <?php foreach ($tabs as $type => $tab_name): ?>
                    <li class="feed__filters-item filters__item">
                        <a class="filters__button <?= $type ? "filters__button--" .  $type : '' ?> <?= ($current_tab === $type) ? 'filters__button--active' : '' ?> button" href="feed.php?type=<?= $type ?? '' ?>">

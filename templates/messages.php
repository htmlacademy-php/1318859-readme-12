                                    ...
                                    <div class="messages__info-wrapper">
                                        <div class="messages__item-avatar">
                                            <a class="messages__author-link" href="profile.php?id=<?= ($message['sender_id']
                                                === intval($_SESSION['user']['id'])) ? $_SESSION['user']['id']
                                                : $id ?>">
                                                <img class="messages__avatar" src="<?= ($message['sender_id']
                                                    === intval($_SESSION['user']['id'])) ? $_SESSION['user']['avatar']
                                                    : $message['avatar'] ?>" alt="Аватар пользователя">
                                            </a>
                                        </div>
                                        <div class="messages__item-info">
                                            ...
                                            <time class="messages__time" datetime="<?= date_format(date_create($message['dt_add']
                                                ?? ''), 'Y-m-d'); ?>">

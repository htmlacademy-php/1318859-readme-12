            ...
            <div class="profile__user user container">
                ...
                <div class="profile__rating user__rating">
                    ...
                    <p class="profile__rating-item user__rating-item user__rating-item--subscribers">
                        <span class="user__rating-amount"><?= $number_of_user_followers ?></span>
                        <span class="profile__rating-text user__rating-text"><?= get_noun_plural_form($number_of_user_followers, 'подписчик', 'подписчика', 'подписчиков') ?></span>
                    </p>
                </div>
                                        ...
                                        <li class="comments__item user">
                                            ...
                                            <div class="comments__info">
                                                ...
                                                <p class="comments__text">
                                                    ...
                                                    монгольской границы. Байкал считается самым глубоким озером в мире.

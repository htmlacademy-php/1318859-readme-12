            ...
            <div class="post-details__wrapper <?= $post['class_name'] ? "post-" . $post['class_name'] : '' ?>">
                <div class="post-details__main-block post post--details">
                    ...
                    <div class="post__indicators">
                        ...
                        <span class="post__view"><?= $views_count ?? '0' ?> <?= get_noun_plural_form($views_count, 'просмотр', 'просмотра', 'просмотров') ?></span>
                    </div>
                    <?php if ($post_tags): ?>
                        <ul class="post__tags">
                                        ...
                                        <li class="comments__item user" <?php if ($i === $count_of_shown_post_comments - 1): ?>id="last_comment"<?php endif; ?>>
                                            ...
                                            <div class="comments__info">
                                                <div class="comments__name-wrapper">
                                                    ...
                                                    <time class="comments__time" datetime="<?= date_format(date_create($post_comments[$i]['publish_time'] ?? ''), 'Y-m-d'); ?>">
                ...
                <div class="post-details__user user">
                    ...
                    <div class="post-details__rating user__rating">
                        <p class="post-details__rating-item user__rating-item user__rating-item--subscribers">
                            <span class="post-details__rating-amount user__rating-amount"><?= $amount_of_user_followers ?? '0' ?></span>
                            <span class="post-details__rating-text user__rating-text"><?= get_noun_plural_form($amount_of_user_followers, 'подписчик', 'подписчика', 'подписчиков') ?></span>
                        </p>
                        <p class="post-details__rating-item user__rating-item user__rating-item--publications">
                            <span class="post-details__rating-amount user__rating-amount"><?= $amount_of_user_posts ?? '0' ?></span>
                            <span class="post-details__rating-text user__rating-text"><?= get_noun_plural_form($amount_of_user_posts, 'публикация', 'публикации', 'публикаций') ?></span>
                        </p>
                    </div>
                    <?php if (!$self_page): ?>
